const homesItems = fetch(
  ...
  .then((data) => {
    ...
    <div class='homes__item invisible-mobile'>
      <img id="homes__img-id" src=${data[2].imageUrl} alt="hotel-image"/>
    ...
    <div class='homes__item invisible-tablet'>
      <img id="homes__img-id" src=${data[3].imageUrl} alt="hotel-image"/>
